...
export const content = {
  ...
  login: {
    ...
    adminOnlyError: 'This portal is for administrators only. Use Student login below.',
    networkError: 'Unable to reach the login server. Please try again.',
    switchToStudent: 'Student login',
  ...
  studentLogin: {
    ...
    subtitle: 'Access fees and your account',
    ...
    studentOnlyError: 'This login is for students only. Use Admin login.',
    networkError: 'Unable to reach the login server. Please try again.',
  },
